...
test('Со строками на входе', 13, function () {
    var tested = number_format;
    ...
    strictEqual(tested('.123'), '0.123', 'На входе .123');
    strictEqual(tested('1234.'), '1 234.', 'На входе 1234.');
    strictEqual(tested('1234.0'), '1 234.0', 'На входе 1234.0');
});
